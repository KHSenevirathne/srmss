        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Operations')" class="grid">
                @can('manage-fleet')
                    ...
                    <flux:sidebar.item icon="identification" :href="route('drivers')"
                        :current="request()->routeIs('drivers')" wire:navigate>
                        {{ __('Drivers') }}
                    </flux:sidebar.item>
                @endcan
                @can('manage-routes')
                    <flux:sidebar.item icon="map" :href="route('routes')" :current="request()->routeIs('routes')"
                        wire:navigate>
                        {{ __('Routes') }}
                    </flux:sidebar.item>
                @endcan
                @can('manage-schedules')
                    <flux:sidebar.item icon="calendar-days" :href="route('schedules')"
                        :current="request()->routeIs('schedules')" wire:navigate>
                        {{ __('Schedules') }}
                    </flux:sidebar.item>
                @endcan
                @can('log-fuel')
                    ...
                    <flux:sidebar.item icon="wrench-screwdriver" :href="route('maintenance-logs')"
                        :current="request()->routeIs('maintenance-logs')" wire:navigate>
                        {{ __('Maintenance') }}
                    </flux:sidebar.item>
                @endcan
            ...
            @can('manage-users')
                <flux:sidebar.group :heading="__('Administration')" class="grid">
                    ...
                    <flux:sidebar.item icon="clipboard-document-list" :href="route('activity-log')"
                        :current="request()->routeIs('activity-log')" wire:navigate>
                        {{ __('Activity Log') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            @endcan
